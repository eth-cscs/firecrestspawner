...
export JUPYTERHUB_API_URL="https://{{ index .Values.config.certificates.letsencrypt.urls 0 }}/hub/api"
export JUPYTERHUB_ACTIVITY_URL="https://{{ index .Values.config.certificates.letsencrypt.urls 0 }}/hub/api/users/${USER}/activity"
