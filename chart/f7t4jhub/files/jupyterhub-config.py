...
#  Default: '/apps/daint/UES/6.0.UP04/sandboxes/sarafael/conda-jhub/share/jupyterhub'
# c.JupyterHub.data_files_path = '/apps/daint/UES/6.0.UP04/sandboxes/sarafael/conda-jhub/share/jupyterhub'
...
# c.JupyterHub.hub_connect_ip = '148.187.16.70'
import socket
...
# c.Spawner.notebook_dir = '~'  # currently firecrest give no access to $HOME on Piz Daint
...
#  Default: set()
# c.Authenticator.allowed_users = {'sarafael'}
...
# this is here mostly as an example of alternative ways
# of finding the name or ip of the node where the
